...
export class LeftTwoComponent implements OnInit, AfterViewInit, OnDestroy {
  ...
  public requestData(): void {
    this.dataSubscription && this.dataSubscription.unsubscribe();
    this.dataSubscription = this.securityHttpService.requestShareSpotCountList().subscribe(results => {
